...
public class MusicAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            viewHolder.isPlaying =  convertView.findViewById(R.id.icon_playing);
            viewHolder.music_name =  convertView.findViewById(R.id.music_name);
            viewHolder.music_singer =  convertView.findViewById(R.id.music_singer);
            viewHolder.music_album =  convertView.findViewById(R.id.music_album);
        ...
        if (fileInfo.size()>0){
            ...
            if (position== MainActivity.currentNumber){
