...
public class MediaService extends MediaBrowserServiceCompat {
    ...
    public void onCreate() {
        super.onCreate();
        mediaSession = new MediaSession(com.archermind.music.service.MediaService.this, "xiaolajiao");
//        服务中通过MediaStore内容提供者查询设备上的音乐得到Cursor对象
    ...
    public class LocalBinder extends Binder {
        ...
        public com.archermind.music.service.MediaService getMediaService(){
            return com.archermind.music.service.MediaService.this;
        }
    }
}