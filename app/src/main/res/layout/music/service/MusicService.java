   ...
   //对于歌曲的监听
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        if(MusicFragment.modeNumber==2) {
            ...
            if(com.archermind.music.MediaActivity.musicFragmentTab==5) {
                MusicFragment.changeView();
            }else if(com.archermind.music.MediaActivity.musicFragmentTab==6){
                com.archermind.music.MusicListFragment.changeView();
                lastOrnext();
            }
        }else {
            //随机
    ...
    public class MusicBinder extends Binder {
       public com.archermind.music.service.MusicService getService() {
            return com.archermind.music.service.MusicService.this;
        }
    }
