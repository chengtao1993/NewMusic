 ...
 * Use the {@link com.archermind.music.MusicListFragment#newInstance} factory method to
...
public class MusicListFragment extends Fragment implements ListView.OnItemClickListener ,View.OnClickListener{
    ...
    public static com.archermind.music.MusicListFragment newInstance(String param1, String param2) {
        com.archermind.music.MusicListFragment fragment = new com.archermind.music.MusicListFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fileInfo = ScanMusic.getData(getActivity(), com.archermind.music.MediaActivity.current_source_path);
    ...
    public void onResume() {
        super.onResume();
        com.archermind.music.MediaActivity.musicFragmentTab=6;
        initView();
    }
                ...
                item_title.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (data_source.getText().equals(((TextView)v).getText())){
                            ...
                            ((com.archermind.music.MediaActivity)getActivity()).musicFragment.changToBtMusic(getActivity());
                        }
                        sourceDialog.dismiss();
                    }
                });
