...
public class aaMusicFragment extends Fragment implements View.OnClickListener,AdapterView.OnItemClickListener{
    ...
    public static com.archermind.music.adapter.MusicAdapter musicAdapter;
    ...
    private com.archermind.music.utils.LrcProcess mlrcProcess;
    ...
    public static com.archermind.music.bean.MusicBean bean;
    public static com.archermind.music.service.MusicService musicService;
    ...
    public static com.archermind.music.MusicFragment newInstance(String param1, String param2) {
        com.archermind.music.MusicFragment fragment = new com.archermind.music.MusicFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fileInfo = com.archermind.music.utils.ScanMusic.getData(getActivity(), com.archermind.music.MediaActivity.current_source_path);
        data_source = view.findViewById(R.id.data_source);
        data_source.setText(com.archermind.music.MediaActivity.current_source_name);
    ...
    public  static Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            //获取其时长
            if (bean != null) {
                com.archermind.music.MusicFragment.
                song.setText(bean.getText_song());
                songer.setText(bean.getText_singer());
                song_pic.setImageBitmap(com.archermind.music.utils.ScanMusic.getArtwork(mContext,bean.getId(),bean.getAlbumID(),true,false));
                //Add by yanglin for Music Null string begin
                ...
                song_pic.setImageBitmap(com.archermind.music.utils.ScanMusic.getDefaultArtwork(mContext,false));
    ...
    private void   scanMusic() {
        ...
        beans = com.archermind.music.utils.ScanMusic.getData(getActivity(), com.archermind.music.MediaActivity.current_source_path);
    ...
    private void bindServiceConnection() {
        Intent intent = new Intent(getActivity(), com.archermind.music.service.MusicService.class);
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            musicService = ((com.archermind.music.service.MusicService.MusicBinder)(service)).getService();
            Log.i("ccc","绑定服务成功");
            //更新ＵＩ线程
            setdata();
        }
    ...
    public void onResume() {
        ...
        initView();
        initLrc();
        com.archermind.music.MediaActivity.musicFragmentTab=5;
    ...
    private void initView() {
        ...
        musicAdapter = new com.archermind.music.adapter.MusicAdapter(getContext(), fileInfo);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        com.archermind.music.MusicFragment.currentNumber=position;
        changeView();
        initLrc();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.music_pre:
                if(com.archermind.music.MusicFragment.bean==null||beans.size()==0){
                    return;
                }
                if (currentNumber>0){
                ...
                bean=fileInfo.get(com.archermind.music.MusicFragment.currentNumber);
                initLrc();
                changeView();
            ...
            case R.id.music_play:
                ...
                if (music_play.isSelected()) {
                    ...
                    outIntent.putExtra("songer",bean.getText_singer());
                    //开始播放
                    if (com.archermind.music.MediaActivity.isFirstStart){
                        com.archermind.music.MediaActivity.isFirstStart=false;
                    }
                    if (tag1 == false) {
                        tag1 = true;
                    } else {
            ...
            case R.id.setting:
                ...
                Toast.makeText(getActivity(),"等待CarSettings加到桌面实现该功能",Toast.LENGTH_LONG).show();
                break;
            ...
            case R.id.data_source:
                ...
                for (String key : com.archermind.music.MediaActivity.name_path.keySet()){
                    ...
                    item_title.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (data_source.getText().equals(((TextView)v).getText())){
                                ...
                                com.archermind.music.MediaActivity.current_source_name = (String) ((TextView)v).getText();
                                if (com.archermind.music.MediaActivity.current_source_name.equals("本地")){
                                    Log.i(TAG,"-----------sourceDialog-----本地---");
                                    com.archermind.music.MediaActivity.current_source_path = (String) com.archermind.music.MediaActivity.name_path.get(com.archermind.music.MediaActivity.current_source_name);
                                    data_source.setText(com.archermind.music.MediaActivity.current_source_name);
                                    beans = com.archermind.music.utils.ScanMusic.getData(getActivity(), com.archermind.music.MediaActivity.current_source_path);
                                    changeDataSource();
                                }else {
    ...
    public void changToBtMusic(Context context){
        ...
        if (bluetoothAdapter != null
            ...
            com.archermind.music.MediaActivity.isBT=true;
            data_source.setText("蓝牙音乐");
        } else {
            data_source.setText(com.archermind.music.MediaActivity.current_source_name);
...
private PopupWindow pop;
    ...
    private void changeDataSource() {
        ...
        if (beans.size() > 0) {
            ...
            song.setText(STRING_NULL);
            songer.setText(STRING_NULL);
            song_pic.setImageBitmap(com.archermind.music.utils.ScanMusic.getDefaultArtwork(getContext(),false));
    ...
    private void changeBtMusicFragment(String titleName,Context context){
        myFagment = null;
        myFagment = new com.archermind.music.BtMusicFragment();
        FragmentTransaction transaction= ((com.archermind.music.MediaActivity)context).getSupportFragmentManager().beginTransaction();
    ...
    private void changeToListFragment() {
        myFagment=null;
        myFagment = new com.archermind.music.MusicListFragment();
    ...
    private void initLrc() {
        mlrcProcess = new com.archermind.music.utils.LrcProcess();
        if(bean!=null) {
